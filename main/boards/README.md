...
> **UART引脚配置提示 (2025-10-22更新)**:
> - 机器人控制串口(UART1)已从GPIO18/19迁移到GPIO21/20
> - 原因：释放GPIO18/19用于ESP32-C3的USB通信
> - 如需使用机器人控制功能，请连接到GPIO21(TX)/GPIO20(RX)
> - 详细说明：[UART引脚迁移文档](../../修改记录/uart-pin-migration.md)
